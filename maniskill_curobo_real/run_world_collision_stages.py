    ...
    *,
    ...
    try:
            ...
            if args.m3_debug_views:
                write_m3_debug_views(
                    ...
                    min_instance_points=int(
                        args.m3_min_instance_points if stage == "m3" else args.m4_min_instance_points
                    ),
                    instance_padding=float(
                        args.m3_instance_padding if stage == "m3" else args.m4_instance_padding
                    ),
                    min_cuboid_dimension=float(args.scene_min_cuboid_dimension),
        ...
        if valid_points < 1000:
            raise RuntimeError(
                f"Invalid RGB-D collision scene for seed={seed}, stage={stage}: "
                f"valid_points={valid_points}. Check camera shader/depth units."
            )
